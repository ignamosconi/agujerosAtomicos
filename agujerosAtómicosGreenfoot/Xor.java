...
public class Xor extends Actor
{
    /**
     * ATRIBUTOS
     */
    ...
    public void act()
    {
        if (Greenfoot.mouseClicked(this)) {
            ...
            //Comparamos los elementos de estadoCohetes y estadoAgujeros y realizamos la operación  XOR
            indice = 0;
            for (AgujeroNegro agujero : agujeros) {
                if ( (estadoCohetes[indice] == estadoAgujeros[indice]) && (estadoAgujeros[indice] == 0 || estadoAgujeros[indice] == 1) ) {
                    //Si son iguales y son 0 o 1, apagamos el agujero negro. Caso contrario lo prendemos.
