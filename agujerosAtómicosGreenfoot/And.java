...
public class And extends Actor {
    ...
    public void act()
    {
        if (Greenfoot.mouseClicked(this)) {
            ...
            //Comparamos los elementos de estadoCohetes y estadoAgujeros y realizamos la operación AND.
            indice = 0;
            for (AgujeroNegro agujero : agujeros) {
                if ( (estadoCohetes[indice] == estadoAgujeros[indice]) && (estadoAgujeros[indice] == 1) ) {
                    //Si son iguales y son 1, prendemos el agujero negro. Caso contrario lo apagamos.
